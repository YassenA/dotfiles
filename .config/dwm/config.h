...
static const char *fonts[]          = {"JetBrains Mono:pxielsize=11", "Symbols Nerd Font:pixelsize=11:antialia=true"};
...
static const char grey[]       = "#696969";
static const char *colors[][3]      = {
        /*               fg         bg         border   */
        [SchemeNorm] = { grey, black, black },
...
static const Layout layouts[] = {
	...
	{ "π",      tile },    /* first entry is default */
	{ "ξ",      NULL },    /* no layout function means floating behavior */
	{ "ω",      monocle },
};
